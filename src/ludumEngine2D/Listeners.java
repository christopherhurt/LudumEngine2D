    ...
    static final KeyListener KEY_LISTENER = new KeyAdapter() {
        ...
        public void keyPressed(KeyEvent pEvt) {
            if (!KEYS_DOWN.contains(pEvt.getKeyCode())) {
                Scene.enqueueInputEvent(new ludumEngine2D.KeyEvent(EventType.KEY_PRESSED, Game.getCurrentScene(),
                        Window.getScreenMouseLocation(), Window.getWorldMouseLocation(), pEvt.getKeyChar()));
            }
        ...
        public void keyReleased(KeyEvent pEvt) {
            Scene.enqueueInputEvent(new ludumEngine2D.KeyEvent(EventType.KEY_RELEASED, Game.getCurrentScene(),
                    Window.getScreenMouseLocation(), Window.getWorldMouseLocation(), pEvt.getKeyChar()));
    ...
    static final MouseListener MOUSE_LISTENER = new MouseAdapter() {
        ...
        public void mousePressed(MouseEvent pEvt) {
            if (!MOUSE_BUTTONS_DOWN.contains(pEvt.getButton())) {
                Scene.enqueueInputEvent(new ludumEngine2D.MouseEvent(EventType.MOUSE_BUTTON_PRESSED, Game.getCurrentScene(),
        ...
        public void mouseReleased(MouseEvent pEvt) {
            Scene.enqueueInputEvent(new ludumEngine2D.MouseEvent(EventType.MOUSE_BUTTON_RELEASED, Game.getCurrentScene(),
                    Window.getScreenMouseLocation(), Window.getWorldMouseLocation(), pEvt.getButton()));
        ...
        public void mouseMoved(MouseEvent pEvt) {
            Scene.enqueueInputEvent(new ludumEngine2D.MouseEvent(EventType.MOUSE_MOVED, Game.getCurrentScene(),
                    Window.getScreenMouseLocation(), Window.getWorldMouseLocation(), ludumEngine2D.MouseEvent.BUTTON_UNKNOWN));
        }
